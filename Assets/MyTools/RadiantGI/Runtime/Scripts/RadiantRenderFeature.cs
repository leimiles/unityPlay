    ...
    public class RadiantRenderFeature : ScriptableRendererFeature {
        ...
        class RadiantPass : ScriptableRenderPass {
            ...
            void RenderGI(CommandBuffer cmd, Camera cam) {
                ...
                if (useNFO) {
	                Shader.SetGlobalVector(ShaderParams.ExtraData4, new Vector4(radiant.nearFieldObscuranceMaxCameraDistance.value, (1f - radiant.nearFieldObscuranceOccluderDistance.value) * 10f, 0, 0));
                ...
                Shader.SetGlobalVector(ShaderParams.ExtraData3, new Vector4(radiant.aoInfluence.value, radiant.nearFieldObscuranceSpread.value * 0.5f, 1f / (radiant.nearCameraAttenuation.value + 0.0001f), nearFieldObscurance));  // global because these params are needed by the compare pass
